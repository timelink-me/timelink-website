                ...
                {[
                  {
                    ...
                    date: t.timeline.projectStartDate,
                    side: "left",
                    color: "blue",
                  },
                  {
                    title: t.timeline.requirementAnalysis,
                    date: t.timeline.requirementDate,
                    side: "right",
                    color: "green",
                  },
                  {
                    title: t.timeline.designPhase,
                    date: t.timeline.designDate,
                    side: "left",
                    color: "purple",
                  },
                  {
                    title: t.timeline.development,
                    date: t.timeline.developmentDate,
                    side: "right",
                    color: "orange",
                  },
                ].map((item, index) => (
      ...
      <section id="use-cases" className="py-20 bg-gray-50 dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: t.useCases.travelPlan,
                emoji: "✈️",
                desc: t.useCases.travelPlanDesc,
              },
              {
                title: t.useCases.historicalEvents,
                emoji: "📚",
                desc: t.useCases.historicalEventsDesc,
              },
              {
                title: t.useCases.projectManagement,
                emoji: "📊",
                desc: t.useCases.projectManagementDesc,
              },
              {
                title: t.useCases.personalGrowth,
                emoji: "🌱",
                desc: t.useCases.personalGrowthDesc,
              },
            ].map((useCase, index) => (
              <div
                key={index}
